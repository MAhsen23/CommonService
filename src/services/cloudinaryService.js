 ...
 */
export const uploadCategoryImage = async (image, categoryId = null) => {
    const publicId = categoryId ? `category_${categoryId}` : null;
    return uploadImage(image, IMAGE_PATHS.CATEGORY, publicId, {
        width: 800,
        height: 800,
        crop: 'fill',
        aspect_ratio: '1:1'
 ...
 */
export const uploadServiceImage = async (image, serviceId = null) => {
    const publicId = serviceId ? `service_${serviceId}` : null;
    return uploadImage(image, IMAGE_PATHS.SERVICE, publicId, {
        width: 800,
        height: 800,
        crop: 'fill',
        aspect_ratio: '1:1'
 ...
 */
export const uploadBannerImage = async (image, bannerId = null) => {
    const publicId = bannerId ? `banner_${bannerId}` : null;
    return uploadImage(image, IMAGE_PATHS.BANNER, publicId, {
        width: 1200,
        height: 600,
        crop: 'fill',
        aspect_ratio: '2:1'
...
/**
 * Helper function to upload order problem pictures
 */
export const uploadOrderProblemPictures = async (images, orderId = null) => {
    const options = {
        publicIdPrefix: orderId ? `order_${orderId}_problem` : 'order_problem',
        width: 1200,
        height: 1200,
        crop: 'limit'
    };
